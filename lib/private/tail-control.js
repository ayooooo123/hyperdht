...
function sealTailExtend(session, state, options) {
  ...
  try {
    ...
    const decodedAdvertisement = decodeRelayCapabilityAdvertisement(advertisement, {
      now: wall
    })
    ...
    if (
      ...
      !b4a.equals(advertisementDigest, transcript.candidateAdvertisementDigest) ||
      !b4a.equals(decodedAdvertisement.routeEncryptionPublicKey, transcript.advertisedTailRouteEncryptionPublicKey) ||
