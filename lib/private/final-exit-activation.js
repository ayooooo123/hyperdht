...
const finalExitActivationRuntime = (() => {
  ...
  function buildDhtExitOpenAuthorityMaterial(state, exitSide) {
    ...
    const deadline =
      state.graceDeadline !== null && state.graceDeadline < state.material.localDeadline
        ? state.graceDeadline
  ...
  class FinalExitActivationSession {
    ...
    takeDhtExitOpenAuthority(...args) {
      ...
      try {
        ...
        const authority = createDhtExitOpenAuthority(buildDhtExitOpenAuthorityMaterial(state, true))
    ...
    takeOpenHandoff(...args) {
      ...
      try {
        ...
        if (state.state !== 'OPEN' || !state.finalMaterial) {
          authentication()
        }
