...
function createDhtExitOpenAuthority(material) {
  const authority = Object.freeze({})
  OPEN_AUTHORITIES.set(authority, { material: openMaterial(material), spent: false })
  return authority
}
...
function createDhtExitReservationChannel(openAuthority) {
  const material = consumeOpenAuthority(openAuthority)
