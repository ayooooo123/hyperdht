...
// Per-epoch, bounded single-use tracker for hop nullifiers. A relay calls admit() for each
// SURB it processes; a repeat within the epoch is rejected (enforces invariant 5). reset()
// at epoch rollover. Bounded by maxEntries with FIFO eviction — size the cap above expected
// per-epoch volume so live nullifiers are not evicted early.
