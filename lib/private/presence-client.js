...
//
// `replyMode` (decision D12): reads, publishing, and revocation use the controller's
// required SURB reply mode when the client is created with
// `replyMode: 'SURB_REQUIRED'`, so their replies never travel the correlated path.
