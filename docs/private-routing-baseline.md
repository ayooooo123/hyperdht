...
- HyperDHT [PR #1](https://github.com/ayooooo123/hyperdht/pull/1), head `58ce078ac4d1cc93fd25667f291ece1262394c42`, ran twice in [workflow run 29540819520](https://github.com/ayooooo123/hyperdht/actions/runs/29540819520). Checkout passed, but `setup-node` with `lts/*` received GitHub Unicorn HTML on macOS and Linux. Windows was canceled by fail-fast. Neither attempt reached `npm install` or a package test.
